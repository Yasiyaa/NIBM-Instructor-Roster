...
1. **Teaching Cadre Count**: Strictly 8 members (2 Demonstrators: Yasith & Kithnuka; 6 Technical Instructors).
2. **Free Standby Formula**: $\text{FreeStandby} = 8 - (\text{OnDuty} + \text{OnLeave})$.
